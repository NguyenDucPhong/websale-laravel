                                ...
                                <div class="bc-item">
                                    <label for="bc-{{$brand->name}}">
                                        ...
                                        <input type="checkbox" {{(request('brand')[$brand->id] ?? '') == 'on' ? 'checked' : ''}}
                                         name="brand[{{$brand->id}}]" id="bc-{{$brand->name}}" onchange="this.form.submit()">
                        ...
                        <div class="filter-widget">
                            ...
                            <div class="fw-color-choose">
                                <div class="cs-item">
                                    ...
                                    <label class="cs-black {{request('color') == 'black' ? 'font-weight-bold' : ''}}"   for="cs-black">balck</label>
                                </div>
                                <div class="cs-item">
                                    ...
                                    <form action="" method="">
                                        ...
                                        <div class="select-option">
                                            <select name="sort_by" id="" class="sorting" onchange="this.form.submit()">
                                                ...
                                                <option {{request('sort_by') == 'price-descending' ? 'selected' : ''}}  value="price-descending">Sorting: Pricec Decrease</option>
                                            </select>
                                            <select name="show" class="p-show" id="" onchange="this.form.submit()">
